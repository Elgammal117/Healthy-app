...
class _WebServices implements WebServices {
  _WebServices(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'http://healthy-app.eu-4.evennode.com/';
  }
  ...
  @override
  Future<Favo> getFavorites(String authHeader) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authHeader};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Favo>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'favorites',
    ...
    late Favo _value;
    try {
      _value = Favo.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
