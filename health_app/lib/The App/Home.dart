          ...
          child: ListView(
            children: [
              ...
              MealCard(
                ...
                time: 20,
                tags: [
                  MealTag(label: 'High Protein', color: Color(0xFF00C896)),
                  MealTag(label: 'Low Carb', color: Color(0xFFFFB088)),
                ],
              ...
              MealCard(
                ...
                time: 15,
                tags: [
                  MealTag(label: 'Fiber Rich', color: Color(0xFF00C896)),
                  MealTag(label: 'Vegan', color: Color(0xFF7ED957)),
                ],
              ...
              MealCard(
                ...
                time: 10,
                tags: [
                  MealTag(label: 'Low Cal', color: Color(0xFF00C896)),
                  MealTag(label: 'Gluten Free', color: Color(0xFF7ED957)),
                ],
